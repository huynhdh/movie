...
const CreateMovieResponse = _i1.ObjectTypeDefinitionNode(
  name: _i1.NameNode(value: 'CreateMovieResponse'),
  directives: [],
  interfaces: [],
  fields: [
...
const Movie = _i1.ObjectTypeDefinitionNode(
  name: _i1.NameNode(value: 'Movie'),
  directives: [],
  interfaces: [],
  fields: [
...
const MovieInput = _i1.InputObjectTypeDefinitionNode(
